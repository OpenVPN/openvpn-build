...
rem This script digitally signs EXE installer.
rem
...
rem
rem Run this script after `cscript build.wsf exe`.

signtool.exe sign /sha1 "%ManifestCertificateThumbprint%" /fd sha256 /tr "%ManifestTimestampRFC3161Url%" /td sha256 image\*.exe
