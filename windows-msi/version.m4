...
define([PRODUCT_OVPN_DCO_VERSION],     [2.8.7])
...
define([PACKAGE_VERSION], [2.7.6-I001])
...
define([PRODUCT_VERSION], [2.7.601])

dnl The MSI product code MUST change on each product release.
define([PRODUCT_CODE], [{0047DAC9-37BF-409A-B3E9-43D782E84D94}])
