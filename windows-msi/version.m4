...
define([PRODUCT_OVPN_DCO_VERSION],     [0.9.4])
...
define([PACKAGE_VERSION], [2.6.6-I001])
...
define([PRODUCT_VERSION], [2.6.601])

dnl The MSI product code MUST change on each product release.
define([PRODUCT_CODE], [{BE31D738-DC52-49C3-9CB1-8978B5FC788B}])
