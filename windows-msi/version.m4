...
define([PRODUCT_OVPN_DCO_URL_x86],     [https://github.com/OpenVPN/ovpn-dco-win/releases/download/0.9.1/ovpn-dco-x86.msm])
define([PRODUCT_OVPN_DCO_URL_amd64],   [https://github.com/OpenVPN/ovpn-dco-win/releases/download/0.9.1/ovpn-dco-amd64.msm])
define([PRODUCT_OVPN_DCO_URL_arm64],   [https://github.com/OpenVPN/ovpn-dco-win/releases/download/0.9.1/ovpn-dco-arm64.msm])
...
define([PACKAGE_VERSION], [2.6.0-I004])
...
define([PRODUCT_VERSION], [2.6.009])

dnl The MSI product code MUST change on each product release.
define([PRODUCT_CODE], [{A662F537-DB6E-4F00-9C2F-7946CBD3F807}])
