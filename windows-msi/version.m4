...
define([PRODUCT_TAP_WIN_URL_x86],      [https://github.com/OpenVPN/tap-windows6/releases/download/9.27.0/tap-windows-9.27.0-I0-i386.msm])
define([PRODUCT_TAP_WIN_URL_amd64],    [https://github.com/OpenVPN/tap-windows6/releases/download/9.27.0/tap-windows-9.27.0-I0-amd64.msm])
define([PRODUCT_TAP_WIN_URL_arm64],    [https://github.com/OpenVPN/tap-windows6/releases/download/9.27.0/tap-windows-9.27.0-I0-arm64.msm])
...
define([PACKAGE_VERSION], [2.5.10-I601])
...
define([PRODUCT_VERSION], [2.5.043])

dnl The MSI product code MUST change on each product release.
define([PRODUCT_CODE], [{F3CB40E9-AC2B-4AEE-B644-847049D29035}])
