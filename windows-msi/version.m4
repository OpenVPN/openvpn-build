...
define([PRODUCT_OVPN_DCO_VERSION],     [1.3.3])
...
define([PACKAGE_VERSION], [2.6.17-I001])
...
define([PRODUCT_VERSION], [2.6.1701])

dnl The MSI product code MUST change on each product release.
define([PRODUCT_CODE], [{0B89690A-92BE-4803-A246-7DC807464BF7}])
