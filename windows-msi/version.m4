...
define([PRODUCT_OVPN_DCO_VERSION],     [1.1.0])
...
define([PACKAGE_VERSION], [2.6.10-I001])
...
define([PRODUCT_VERSION], [2.6.1001])

dnl The MSI product code MUST change on each product release.
define([PRODUCT_CODE], [{B0168D30-5FDB-49B3-BD29-8F6D87543786}])
