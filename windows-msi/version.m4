...
define([PRODUCT_OVPN_DCO_VERSION],     [2.8.3])
...
define([PACKAGE_VERSION], [2.7.5-I001])
...
define([PRODUCT_VERSION], [2.7.501])

dnl The MSI product code MUST change on each product release.
define([PRODUCT_CODE], [{B766B97E-E81C-4B7D-8948-067E4D42C88A}])
