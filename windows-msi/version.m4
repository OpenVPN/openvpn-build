...
define([PRODUCT_TAP_WIN_URL_x86],      [https://github.com/OpenVPN/tap-windows6/releases/download/9.25.0/tap-windows-9.25.0-I0-i386.msm])
define([PRODUCT_TAP_WIN_URL_amd64],    [https://github.com/OpenVPN/tap-windows6/releases/download/9.25.0/tap-windows-9.25.0-I0-amd64.msm])
define([PRODUCT_TAP_WIN_URL_arm64],    [https://github.com/OpenVPN/tap-windows6/releases/download/9.25.0/tap-windows-9.25.0-I0-arm64.msm])
...
define([PACKAGE_VERSION], [2.6.3-I001])
...
define([PRODUCT_VERSION], [2.6.301])

dnl The MSI product code MUST change on each product release.
define([PRODUCT_CODE], [{C58E9B75-B861-4867-B456-051A26368057}])
