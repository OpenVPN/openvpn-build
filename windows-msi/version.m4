...
define([PRODUCT_OVPN_DCO_URL_x86],     [https://github.com/OpenVPN/ovpn-dco-win/releases/download/0.9.0/ovpn-dco-x86.msm])
define([PRODUCT_OVPN_DCO_URL_amd64],   [https://github.com/OpenVPN/ovpn-dco-win/releases/download/0.9.0/ovpn-dco-amd64.msm])
define([PRODUCT_OVPN_DCO_URL_arm64],   [https://github.com/OpenVPN/ovpn-dco-win/releases/download/0.9.0/ovpn-dco-arm64.msm])
...
define([PACKAGE_VERSION], [2.6.0-I003])
...
define([PRODUCT_VERSION], [2.6.008])

dnl The MSI product code MUST change on each product release.
define([PRODUCT_CODE], [{F386759B-B420-4BE5-B9C3-C7C980E2F783}])
